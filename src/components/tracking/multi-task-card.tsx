    ...
    return (
        <div
            className={cn(
                ...
                isDisabled && !goalReached && "border-border/30 bg-bg-elevated/30",
                !goalReached && !isDisabled && "border-accent-pink/70 bg-accent-pink/25",
        ...
        >
            ...
            <span
                className={cn(
                    ...
                    goalReached && "border-accent-pink/25 bg-accent-pink/8 text-text/40 border",
                    isDisabled && !goalReached && "border-border/30 bg-bg-elevated/30 text-text-muted/50 border",
                    !goalReached && !isDisabled && "border-accent-pink/60 bg-accent-pink/20 text-text border",
                )}
            >
            ...
            <div className="flex min-w-24 flex-1 flex-wrap gap-2 self-stretch">
                <button
                    ...
                    className={cn(
                        ...
                        goalReached && "border-accent-pink/30 bg-accent-pink/10 text-text/50",
                        isDisabled && !goalReached && "bg-bg-elevated/20 text-text-muted/50 border-transparent",
                        !goalReached && !isDisabled && "border-accent-pink/80 bg-accent-pink/80 text-text",
                        isDisabled && "cursor-default",
